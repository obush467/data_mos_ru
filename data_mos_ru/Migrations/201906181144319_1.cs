        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    ADR_TYPE = c.String(maxLength: 2000),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    AdmArea = c.String(maxLength: 2000),
                    system_object_id = c.String(maxLength: 2000),
                    UNOM = c.Int(),
                    KAD_RN = c.Int(),
                    KAD_KV = c.Int(),
                    KAD_ZU = c.Int(),
                    DMT = c.String(maxLength: 2000),
                    KRT = c.String(maxLength: 2000),
                    VLD = c.String(maxLength: 2000),
                    STRT = c.String(maxLength: 2000),
                    SOOR = c.String(maxLength: 2000),
                    TDOC = c.String(maxLength: 2000),
                    NDOC = c.String(maxLength: 2000),
                    DDOC = c.DateTime(),
                    NREG = c.Int(),
                    DREG = c.DateTime(),
                    VYVAD = c.String(maxLength: 2000),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Number = c.Int(),
                    global_id = c.Int(nullable: false),
                    MO_Type_C = c.String(maxLength: 2000),
                    MO_Type_N = c.String(maxLength: 2000),
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    MO_Code = c.String(maxLength: 2000),
                    MO_Name = c.String(maxLength: 2000),
                    MO_Trans = c.String(maxLength: 2000),
                    MO_Type = c.String(maxLength: 2000),
                    MO_TE = c.String(maxLength: 2000),
                    MO_OKTMO = c.String(maxLength: 2000),
            ...
            CreateTable(
                ...
                c => new
                {
                    ID = c.Guid(nullable: false, identity: true),
                    global_id = c.Int(nullable: false),
                    Kod = c.String(maxLength: 2000),
                    Name = c.String(maxLength: 2000),
                    Latin_Name = c.String(maxLength: 2000),
                    Type = c.String(maxLength: 2000),
                    Kod_okato = c.String(maxLength: 2000),
                })
                .PrimaryKey(t => t.ID);
