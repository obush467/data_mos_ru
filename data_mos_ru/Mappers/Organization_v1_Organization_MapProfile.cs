...
{
    internal class Organization_v1_Organization_MapProfile : Profile
    {
        public UNSModel ContexUNS { get; private set; }

        public Organization_v1_Organization_MapProfile(UNS.Models.UNSModel context) : this()
        {
            ContexUNS = context;
        }
        public Organization_v1_Organization_MapProfile()
        {
            CreateMap<data_Organization_v1, Organization>()
